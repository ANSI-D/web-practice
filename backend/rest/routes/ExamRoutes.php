...
Flight::route('GET /employees/performance', function () {
    ...
    try {
        ...
        Flight::json($service->employees_performance_report());
    } catch (Exception $e) {
...
Flight::route('DELETE /employee/delete/@employee_id', function ($employee_id) {
    ...
    try {
        $service = new ExamService();
        Flight::json($service->delete_employee($employee_id));
    } catch (Exception $e) {
        Flight::json(['error' => $e->getMessage()]);
    }
});
...
Flight::route('PUT /employee/edit/@employee_id', function ($employee_id) {
    ...
    try {
        ...
        $service = new ExamService();
        $updated_employee = $service->edit_employee($employee_id, $data);
        Flight::json($updated_employee);
    } catch (Exception $e) {
        Flight::json(['error' => $e->getMessage()]);
    }
});
...
Flight::route('GET /orders/report', function () {
    ...
    try {
        $service = new ExamService();
        Flight::json($service->get_orders_report());
    } catch (Exception $e) {
        Flight::json(['error' => $e->getMessage()]);
    }
});
